    ...
    private function startMatch() {
        if ($this->ready['ct'] && $this->ready['t']) {
            if ($this->getStatus() == self::STATUS_WU_KNIFE) {
                ...
                $this->rcon->send("mp_halftime_duration 1; mp_roundtime_defuse 60; mp_ct_default_secondary \"\"; mp_t_default_secondary \"\"; mp_startmoney 0; mp_give_player_c4 0; mp_free_armor 1;");
                ...
                switch ($this->currentMap->getStatus()) {
                    case Map::STATUS_WU_1_SIDE:
                        ...
                        $this->rcon->send("sv_rcon_whitelist_address \"" . \eBot\Config\Config::getInstance()->getBot_ip() . "\"");
                        $this->rcon->send("mp_halftime_duration 1; mp_ct_default_secondary \"weapon_hkp2000\"; mp_t_default_secondary \"weapon_glock\"; mp_give_player_c4 1");
                        $this->rcon->send("mp_warmup_end");
